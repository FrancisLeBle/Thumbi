...
var (
	...
	ErrSeatsExceedCapacity       = errors.New("la cantidad de asientos ofertados supera la capacidad del vehículo")
	...
	ErrCannotCancelStartedTrip   = errors.New("no es posible cancelar un viaje que ya se encuentra en curso o completado")
	...
	ErrBookingAlreadyCancelled   = errors.New("la reserva ya se encuentra cancelada")
